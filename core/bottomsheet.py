...
Reimplementation with Stack Layout instead of GridLayout
...
# Changed from Gridlayout to StackLayout
class BottomSheetContent(BackgroundColorBehavior, StackLayout):
    pass
